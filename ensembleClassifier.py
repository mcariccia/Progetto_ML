...
X_features = dataset.drop(labels=['CCA3', 'Rank', 'Capital', 'Continent', 'Country/Territory'], axis=1)
...
def evaluate_ensemble (ensemble, Y_test):
    ...
    print("Decision Tree Precision: ", precision_score(Y_test, ensemble.DTree_pred, average='macro'))
    ...
    print("Support Vector Precision: ", precision_score(Y_test, ensemble.SVC_pred, average='macro'))
    ...
    print("Naive Bayes Precision: ", precision_score(Y_test, ensemble.NBayes_pred, average='macro'))
    ...
    print("Hard Voting Precision: ", precision_score(Y_test, ensemble.hard_pred, average='macro'))
...
def ensemble_classifier (X, Y, stratify = None):
    #crea i set di training e test, con uno split 0.8 - 0.2
    X_train, X_test, Y_train, Y_test = train_test_split(X, Y, test_size=0.2, random_state=30, stratify=stratify)
...
ensemble_classifier(X_features, Y_label)
